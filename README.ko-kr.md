...
2. Xcode에서 `GrowSpaceSDKTestApp.xcodeproj` 열기. SwiftPM 이 `https://github.com/freegrowenterprise/SpaceSDK-iOS` 의 `0.0.42` 태그를 자동으로 가져옵니다.
